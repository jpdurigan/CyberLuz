...
func enter(_msg: Dictionary) -> void:
	...
	_attack_area.connect("player_exited", Callable(self, "_on_attack_area_player_exited"))
	attack()

func exit() -> Dictionary:
	_attack_area.disconnect("player_exited", Callable(self, "_on_attack_area_player_exited"))
	return {}
